...
(function() {
    ...
    const allow_paste_in_textbox = false // allow pasting if selecting a textbox (master can overwrite ths) [TYPE: Bool, VALUES: true | false] (DEPRECATED & unused)
    ...
    const replace_google_url = "about:blank#blocked" // URL to replace google with. Requires disable_google_completely, set to true  [TYPE: String, VALUES: any string]
    const hide_google = false // Hides google. (DEPRECATED & UNUSED)
    ...
    } else if(sessionStorage.getItem("password-submitted") == "true" && require_password == true) {
